...
server {
    ...
    rewrite ^/inc/([a-zA-Z]+)/(.+)$      /modules/$1/inc/$2 last;
    ...
    #catch objects
    rewrite ^/([a-zA-Z]+)/([0-9]+)$    /?request=object&type=$1&id=$2 last;      #get
    rewrite ^/([a-zA-Z]+)/([0-9]+)/([a-zA-Z\.]+)$    /?request=object&type=$1&id=$2&action=$3 last;      #get+post

    #catch modules
    rewrite ^/([a-zA-Z]+)$               /?request=module&module=$1 last;         #get+post
    rewrite ^/([a-zA-Z]+)/([a-zA-Z]+)$               /?request=module&module=$1&module_request=$2 last;         #get+post
    rewrite ^/([a-zA-Z]+)/([a-zA-Z]+)/([a-zA-Z]+)$               /?request=module&module=$1&module_request=$2&action=$3 last;         #get+post
